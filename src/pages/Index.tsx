        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-3xl mx-auto">
              ...
              увлекательные материалы. Помогаю студентам и профессионалам
              освоить математику на новом уровне.
            </p>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-slate-600 mb-6">
                Кандидат математических наук с 15-летним опытом преподавания и
                популяризации математики. Создаю образовательный контент для
                различных аудиторий — от школьников до специалистов.
              </p>
